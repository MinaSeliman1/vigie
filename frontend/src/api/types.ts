...
export type CreateSiteInput = { name: string; type: 'Indoor' | 'Outdoor'; timeZoneId: string; startMonth: number; startDay: number; endMonth: number; endDay: number; address?: string; neighborhood?: string; isMunicipal: boolean; sectorId?: string | null }
