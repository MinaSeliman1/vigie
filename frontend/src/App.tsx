...
import type { AuditEntryResponse, AvailabilityResponse, CoverageResponse, MembershipResponse, NotificationResponse, Role as ApiRole, SectorResponse, CertificationResponse, SiteResponse, ShiftResponse, SwapRequestResponse, UserSummary } from './api/types'
  ...
  useEffect(() => {
    ...
    async function syncApi() {
      try {
        ...
        const [apiShifts, apiSwaps, employees, apiCertifications, apiSites, apiAvailabilities, apiSectors, apiMembers, apiAudit, apiNotifications, apiCoverage] = await Promise.all([vigieApi.shifts(), vigieApi.swaps(), vigieApi.employees(), vigieApi.certifications(), vigieApi.sites(), vigieApi.availability(), vigieApi.sectors(), vigieApi.members(), isManagement ? vigieApi.audit() : Promise.resolve([]), vigieApi.notifications(), isManagement ? vigieApi.coverage() : Promise.resolve([])])
        if (!isCurrent()) return
