...
function App() {
  ...
  function openAuth(mode: AuthMode) { setAuthError(''); setAuthForm({ organizationName: '', name: '', email: '', password: '' }); setAuthModal(mode) }
  ...
  async function submitAuth(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (mode === 'password-reset-confirm') {
        ...
        setAuthForm({ organizationName: '', name: '', email: '', password: '' })
        setAuthModal('login')
        flash(response.message)
        return
      }
