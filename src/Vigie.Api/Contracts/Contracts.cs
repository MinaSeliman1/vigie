...
public sealed record ShiftResponse(Guid Id, Guid SiteId, string SiteName, string SiteType, DateTimeOffset StartUtc, DateTimeOffset EndUtc, int RequiredLifeguards, IReadOnlyCollection<AssignmentResponse> Assignments, string Status = nameof(ShiftStatus.Open), string PublicationStatus = nameof(ShiftPublicationStatus.Draft));
public sealed record CoverageResponse(Guid ShiftId, Guid SiteId, string SiteName, DateTimeOffset StartUtc, DateTimeOffset EndUtc, int RequiredLifeguards, int AssignedLifeguards, bool IsCovered, string Status, string PublicationStatus);
